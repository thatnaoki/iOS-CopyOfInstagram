...
//  InstagramCopy
//
//  Created by Naoki Muroya on 2019/03/04.
...
class FeedCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        optionsButton.anchor(top: nil, left: nil, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 0, height: 8)
